...
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=319 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `quizes` VALUES (1,1,'Historia i struktura PŁ',10,'easy'),(2,1,'Regulamin studiów - Prawa i obowiązki studenta',12,'medium'),(3,1,'Kampus PŁ - Topografia i budynki',10,'easy'),(4,2,'Władze i Instytuty Wydziału EEIA',10,'medium'),(5,2,'Procedury dyplomowania na EEIA',12,'hard'),(6,3,'Wprowadzenie do UX i UI Design',10,'easy'),(7,3,'Heurystyki użyteczności Nielsena',15,'hard'),(8,3,'Dostępność cyfrowa (WCAG)',12,'medium'),(9,4,'Podstawy języka SQL - SELECT i JOIN',12,'medium'),(10,4,'Normalizacja i relacje',15,'hard'),(11,5,'Architektura mikrokontrolerów',12,'medium'),(12,5,'Arduino - Wstęp do prototypowania',10,'easy'),(13,5,'Przerwania i systemy czasu rzeczywistego',15,'hard'),(14,1,'Szybki test wiedzy o rekrutacji',3,'easy'),(17,5,'STM32',2,'hard');
...
-- Dump completed on 2026-01-27  0:40:50
